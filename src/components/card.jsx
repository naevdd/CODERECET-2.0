  ...
  return (
    <div
      ...
      className={`
        ...
        ${flipped ? "bg-white md:-translate-y-52 md:scale-100 scale-110 text-sm md:text-3xl" : "bg-custom-yellow text-2xl md:text-5xl md:scale-100 scale-90"}
        ...
        ${isDesktop 
          ...
          : "md:!scale-100 md:hover:!scale-100" }
      `}
    >
