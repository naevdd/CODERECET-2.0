  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          flipped
            ? "bg-custom-white md:-translate-y-52 text-sm md:text-3xl"
            : "bg-custom-yellow text-2xl md:text-5xl"
        }
        ${animating ? "md:animate-rotateRight" : ""}
        flex border-custom-black border-[1.5px] md:-skew-y-12 my-10 shadow-2xl 
