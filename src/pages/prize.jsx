...
const Prize = () => {
  return (
    <div className="bg-custom-black border-custom-gray flex flex-col gap-y-2 md:gap-y-9 items-center justify-start min-h-screen">
      <div className="text-custom-yellow font-seasons_r text-[48px] md:text-8xl mt-8 md:mt-0">
        PRIZES
      </div>
      ...
      <div className="flex flex-wrap border-custom-gray md:border-t md:border-b md:flex-nowrap items-center justify-center md:h-[800px] w-full">
        ...
        <div className="h-full order-2 md:order-1 pb-14 px-5 flex flex-col items-center justify-center space-y-4 md:space-y-7">
          <img
            src={second}
            alt="second"
            className="mt-16 md:mt-32 hover:-translate-y-3  
                            hover:drop-shadow-[0_0_90px_rgba(122,114,111,1)] hover:brightness-100 
                            transition-all duration-700 ease-in-out"
          />
          <div className="font-seasons_r text-white text-3xl md:text-5xl">
            SECOND
          </div>
        ...
        <div className="h-full order-1 md:order-2 border-custom-gray md:border-l md:border-r pb-14 px-5 flex flex-col items-center justify-center space-y-4 md:space-y-7">
          <img
            src={first}
            alt="first"
            className="mt-16 md:-mt-32 hover:-translate-y-3 transition-all duration-700 hover:filter hover:drop-shadow-[0px_0px_30px_rgba(215,159,24,1)] filter drop-shadow-[0px_0px_5px_rgba(215,159,24,0.5)]"
          />
          <div className="font-seasons_r text-white text-3xl md:text-5xl">
            FIRST
          </div>
        ...
        <div className="h-full order-3 md:order-3 border-custom-gray pb-14 px-5 flex flex-col items-center justify-center space-y-4 md:space-y-7">
          <img
            src={third}
            className="mt-16 md:mt-32 drop-shadow-[0_0_30px_rgba(118,53,37,1)] 
