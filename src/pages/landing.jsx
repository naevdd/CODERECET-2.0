        ...
        <div className='h-screen bg-black'>
            ...
            <div className='flex justify-center'>
                <nav className="flex mt-10 w-full">
                    ...
                    <button className='bg-yellow-600 w-48 h-12 rounded-full mr-10'>
            ...
            <div className='flex flex-col items-center'>
                ...
                '>CET'S BIGGEST <br></br> <span className='text-yellow-500'>HACKATHON</span> IS BACK.</h1>
                <button className='bg-yellow-600 border-2 mt-5 z-40 border-white w-48 h-12 rounded-full'>
                ...
                <div className='h-20 -mt-[18rem] w-full z-10 bg-black inline-flex flex-nowrap border-2 border-l-0 border-r-0 border-gray-400'>
                <div className="overflow-hidden relative">
                <div className="flex animate-infinite-scroll space-x-16 sm:space-x-36 p-2">
                {words.concat(words).map((word, index) => (
                <li
                    key={index}
                    className="text-sm sm:text-lg lg:text-6xl list-none text-gray-400 font-seasons_r whitespace-nowrap"
                >
                    {word}
                </li>
                ))}
