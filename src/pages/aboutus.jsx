        ...
        <div className="flex lg:hidden justify-center items-center w-full mt-10 py-8 lg:pr-[200px] lg:mr-[50px] lg:ml-[50px] relative">
          ...
          <div className="relative w-[280px] sm:w-[320px] h-[440px] sm:h-[480px] mx-8">
            ...
            <div className="absolute z-20 w-full h-full rounded-2xl border border-[#FFD700] shadow-lg bg-[linear-gradient(to_bottom,#565D60_1%,#0A0A0A_100%)] flex flex-col items-center justify-between p-5">
              ...
              <button className="w-full mt-5 flex items-center justify-center p-3 rounded-lg bg-custom-yellow text-[#0A0A0A] font-seasons_r text-lg sm:text-xl hover:bg-yellow-700 hover:scale-105 transition-all ease-in-out">
      ...
      <div className="hidden lg:flex justify-center items-center w-auto mt-0 relative">
        ...
        <div className="relative w-[400px] h-[600px]">
          ...
          <div className="absolute z-20 w-full h-full rounded-2xl border border-[#FFD700] shadow-lg bg-[linear-gradient(to_bottom,#565D60_1%,#0A0A0A_100%)] flex flex-col items-center justify-between p-5">
            ...
            <button className="w-full mt-5 flex items-center justify-center p-3 rounded-lg bg-custom-yellow text-[#0A0A0A] font-seasons_r text-xl hover:bg-yellow-700 hover:scale-105 transition-all ease-in-out">
              Register Now <img src={arrow} className="ml-2 w-5 h-4" />
            </button>
          </div>
        </div>
