  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-auto px-2 lg:px-0">
        ...
        <h2 className="text-custom-white text-[17px] pr-4 font-satoshi_v mt-3 w-full lg:max-w-[500px]">
          ...
          {[
            ...
            <li key={index} className="flex flex-row items-center gap-3">
              ...
              <div
                ...
                bg-[linear-gradient(to_bottom,#565D60_1%,#000000_100%)] rounded-md w-full lg:max-w-[380px]"
              >
